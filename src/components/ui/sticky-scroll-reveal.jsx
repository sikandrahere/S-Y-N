...
export const StickyScroll = ({
  ...
  return (
    <motion.div
      ...
      className="relative flex h-[30rem] justify-center space-x-10 overflow-y-auto scrollbar-hidden overflow-auto rounded-md p-10"
      ref={ref}>
      ...
      <div
        ...
        className={cn(
          "sticky top-10 hidden p-10 lg:block",
          contentClassName
        )}>
